...
class ApiClient {
  ...
  Future<dynamic> getRequest(String url, {dynamic queryParams}) async {
    ...
    final response =
        await _dio.get("$url", options: options, queryParameters: queryParams);
  ...
  Future<dynamic> putRequest(String url, dynamic body) async {
    ...
    final response = await _dio.put("$url", options: options, data: body);
  ...
  Future<dynamic> patchRequest(String url, dynamic body) async {
    ...
    final response = await _dio.patch("$url", options: options, data: body);
  ...
  Future<dynamic> postRequest(String url, dynamic body) async {
    ...
    final response = await _dio.post("$url", options: options, data: body);
